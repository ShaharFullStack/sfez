          ...
          {isExpanded && (
            <div className="absolute bottom-16 right-0 mb-2 space-y-2 animate-fade-in-up">
              <Button
                ...
                className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full shadow-lg whitespace-nowrap"
              >
              ...
              <Button
                ...
                className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full shadow-lg whitespace-nowrap"
              >
                <span className="text-lg">💬</span>
                {t('contact.whatsapp')}
              </Button>
