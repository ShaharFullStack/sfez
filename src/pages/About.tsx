        ...
        <div className="container mx-auto px-4">
          ...
          <div className="card-elegant p-4 mb-16 hover-lift">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center">
                <div className="w-64 h-64 bg-primary rounded-full mx-auto mb-4 flex items-center justify-center shadow-2xl hover-scale">
                  <OptimizedImage 
                    src="/images/Shai.jpg" 
                    alt="שי ספז" 
          ...
          <div className="card-elegant p-8 mb-16 hover-lift">
            <div className="text-center">
              ...
              <Badge 
              className="bg-gradient-to-r from-primary to-primary/80 text-white text-lg px-6 py-2 hover-scale">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
